...
This workspace is being initialized. A template payload is staged at \`.workspace-update/\`.

**MANDATORY: Read and follow the workspace-init skill before doing anything else:**

@.workspace-update/.claude/skills/workspace-init/SKILL.md

## Rules (loaded from template payload)
